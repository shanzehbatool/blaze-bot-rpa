...
<script src="https://ajax.googleapis.com/ajax/libs/jqueryui/1.12.1/jquery-ui.min.js"></script>
    ...
    <script>
        ...
        /*var date = $("#txtContact").datepicker("getDate");*/
    </script>
...
<body style="background-image: url('indeximgf1.jpg')">
    ...
    <div>
            ...
            <%--<h2 style="width: 500px; font-weight:bold; font-size: 20px; margin-top:-1px; margin-left:30px; color:#fff;">Say Yes<br /> To Bot</h2>   
            --%></div>

            <h2 style="width: auto; text-align:center; font-weight:bold; font-size:30px; color:paleturquoise; margin-top:-65px; margin-bottom:30px; margin-left:-750px;">
               
                Modify Employee Data</h2>        
    

        
            <%--<hr class="line" style="width:100%; height:-1px;border-color:white; margin-left:0px; margin-top:10px"/>--%>
    ...
    <form id="form1" runat="server">
        <div style="text-align:center">
            ...
            <asp:GridView ID="gvEmp" runat="server" AutoGenerateColumns="False" ShowFooter="True" DataKeyNames="MailID"
                ...
                BackColor="White" BorderColor="#999999" BorderStyle="Solid" BorderWidth="1px" CellPadding="3" OnSelectedIndexChanged="gvEmp_SelectedIndexChanged" Width="969px" ForeColor="Black" GridLines="Vertical" HorizontalAlign="Center"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Joining Date">
                        ...
                        <EditItemTemplate>
                            <asp:TextBox ID="txtContact" Text='<%# Eval("JoiningDate","{0:dd/MM/yy}") %>' runat="server" />
                        </EditItemTemplate>
                        <FooterTemplate>
