...
function runProcess(processName) {
    ...
    promise.then(function (processes) {
        ...
        /*document.getElementById(elementId).innerHTML = '<b></b>';*/
...
function buildRobotTable(robots) {
    ...
    for (var i = 0; i < robots.length; i++) {
        ...
        robotList += "<tr><td><button onclick=runProcess('" + robots[i].id + "');>Enable to Onboard</button></td><td><div id='" + eleStatus + "'</td><td><div id='" + jobStatus + "'</td></tr>";
    }
    table += robotList;
